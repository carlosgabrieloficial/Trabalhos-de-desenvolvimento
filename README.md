...
disciplinas para propor soluções que atendam às necessidades do cenário apresentado. A partir da situaçãoproblema,
serão desenvolvidas atividades específicas que envolvem análise, planejamento, modelagem e
implementação de soluções voltadas à área de tecnologia da informação.

Passo 2:
Situação:
A Sra. Helena precisa de um sistema simples para cadastrar pacientes e calcular algumas estatísticas
básicas da clínica.
Problema:
